...
const Post = ({ post, deletePost }) => {
  ...
  useEffect(() => {
    ...
    // const postUnsubscribe1 = onSnapshot(postRef, (docSnapshot) => {
    ...
    const postUnsubscribe = onSnapshot(q, (docSnapshot) => {
      // const postData = docSnapshot.data();
      const postData = docSnapshot.docs.map((doc) => doc.data());
      setLikes(postData[0].likes || []);
      setComments((postData[0].comments || []).reverse());
    });
